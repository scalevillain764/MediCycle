...
namespace Application.Interfaces
{
    ...
    {
        Task<Result<AuthLoginDTOandRegistrationResponse>> RegisterWorkerAsync(AuthWorkerRegistrationDTO DTO, CancellationToken token); // only for admin
        Task<Result<AuthLoginDTOandRegistrationResponse>> RegisterClientAsync(AuthClientRegistrationDTO DTO, CancellationToken token);
